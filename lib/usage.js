...
export function normalizePercent(value) {
  ...
  // API returns fractions (0.0-1.0) or percentages (0-100).
  // Values in [0, 1.0] are treated as fractions: 0.72 -> 72, 1.0 -> 100.
  // Note: a true 1% would be ambiguous, but the API's fraction format
  // returns 0.01 for 1%, so value=1 always means 100%.
